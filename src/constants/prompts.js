...
[분량] 카카오톡 메시지는 반드시 400자 이내로 작성하라. 300자 이상, 400자 이하. 400자 초과 시 출력 무효.
구조: 한 줄 제목 + 핵심 2~3문장 + CTA 링크. 절대 보도자료를 축약하지 마라. 완전히 새로운 짧은 메시지로 작성하라.
예시:
"🎉 브릿츠메디, 토르RF 태국 독점유통 계약 체결!

🌏 태국 더마 솔루션스와 3년간 연 300대 규모 독점유통 계약을 체결했어요.
올 하반기부터 태국 피부과에 납품을 시작해요.
