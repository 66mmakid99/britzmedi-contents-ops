...
- 구조: 아래 형식으로 카드별 작성
  ...
  [카드7-요약] 핵심 3줄 요약
  [카드8-CTA] 행동 유도
- 이모지: 카드당 0~1개 (절제하여 사용)
- 전문용어 최소화
- 설문 데이터: 카드뉴스에서 완전 금지 (복잡한 데이터 인용 부적합)
...
- 섹션 구분은 [훅], [본문] 같은 대괄호 라벨만 사용`,
  ...
  instagram: {
    name: '📸 Instagram',
    charTarget: '캡션 300~500자 + 캐러셀 5장+',
    formatPrompt: `## Instagram 포스트 포맷 규칙
- 캡션 톤: 격식체 또는 간결한 명사형
- 슬라이드 톤: 명사형 종결 또는 짧은 문장
- 분량: 캡션 300~500자 + 캐러셀 슬라이드 5장 이상
- 구조: 아래 섹션 라벨을 반드시 사용하여 구분
  [캡션] 짧은 문장, 핵심 메시지. 첫 줄에 훅
  [캐러셀1-표지] 핵심 뉴스 한 줄 + 비주얼 설명
  [캐러셀2] 핵심 뉴스 상세
  [캐러셀3] 제품/기술 포인트
  [캐러셀4] 의미/전망
  [캐러셀5-CTA] 마지막 슬라이드 (저장/공유 유도)
  [해시태그] 관련 해시태그 15~20개 (한글+영어, 23개 이상 스팸 주의)
- 이모지: 캡션 3개 이내, 슬라이드 카드당 1개 이내
- 비주얼 중심 설명
- 설문 데이터: 인스타그램에서 완전 금지 (시각 콘텐츠에 부적합)
...
7. 채널별 팩트 비율 기준: 보도자료 100%, 블로그 80%, LinkedIn 70%, 카카오/인스타 해당없음
`;
...
[채널: 카카오톡 카드뉴스]
형식: 카드뉴스형 요약 메시지 (6~8카드)
톤: 격식체(~습니다) — 반말/캐주얼 금지
분량: 카드당 40~80자

요구사항:
1. 카드1-표지: 충격 숫자 또는 질문 (20자 이내)
2. 카드2~6: 핵심 뉴스/배경/제품기술/의미전망/마무리
3. 카드7-요약: 핵심 3줄 요약
4. 카드8-CTA: 행동 유도
5. 이모지: 카드당 0~1개 (절제)
6. 설문 데이터: 완전 금지
...
캡션 톤: 격식체 또는 간결한 명사형
슬라이드 톤: 명사형 종결 또는 짧은 문장
분량: 슬라이드당 50~150자, 캡션 300~500자

요구사항:
1. 슬라이드 1 (표지): 핵심 뉴스 한 줄 + 비주얼 설명
2. 슬라이드 2~4: 핵심 뉴스/제품기술/의미전망
3. 슬라이드 5 (CTA): 저장/공유 유도
4. 각 슬라이드는 독립적으로 읽혀도 의미가 통해야 함
5. 캡션: 핵심 메시지, 첫 줄에 훅
6. 해시태그: 15~20개 (23개 이상 스팸 주의)
7. 이모지: 캡션 3개 이내, 슬라이드 카드당 1개 이내
8. 설문 데이터: 완전 금지
