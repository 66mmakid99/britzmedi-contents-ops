...
[라벨 출력 규칙 — 절대 준수]
- 모든 섹션 라벨은 반드시 대괄호 형식으로 출력: [제목], [부제목], [도입부], [핵심요약] 등
- 대괄호 없이 '제목', '부제목', '도입부' 같이 텍스트만 쓰면 출력 무효
- 라벨과 내용 사이에 줄바꿈 1개
...
[분량] 반드시 2,200자 이상, 3,500자 이내로 작성하세요. 2,200자 미만이면 출력 무효입니다.
특히 '기술 설명 섹션'에서 기존 RF와의 차이를 비유나 쉬운 설명으로 2~3문장 더 풀어주세요.
...
[부제목]
제목과 반드시 다른 내용이어야 합니다. 제목을 복사하지 마세요.
제목: SEO 키워드 + 핵심 팩트
